...
public class Dip {
    ...
    // ex 2c
    static final int NUM_PICKED_STARS = 2;
    static final int NUM_PICKED_NUMBERS = 5;
    static final int NUM_STARS = 10;
    static final int NUM_NUMBERS = 50;
    ...
    public Dip(int[] arrayOfNumbers, int[] arrayOfStarts) {
        ...
        if (NUM_PICKED_NUMBERS == arrayOfNumbers.length && NUM_PICKED_STARS == arrayOfStarts.length) {
    ...
    public static Dip generateRandomDip() {
        ...
        for (int i = 0; i < NUM_PICKED_NUMBERS; ) {
            int candidate = generator.nextInt(NUM_NUMBERS - 1) + 1;
        ...
        for (int i = 0; i < NUM_PICKED_NUMBERS; ) {
            int candidate = generator.nextInt(NUM_STARS - 1) + 1;
